...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/ittapi-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ittapi-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add ittapi ittapi-static
# for installing globally
pixi global install ittapi ittapi-static
```
...
It is possible to list all of the versions of `ittapi` available on your platform:
...
```
pixi search ittapi --channel conda-forge
```
